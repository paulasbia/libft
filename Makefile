...
#    Updated: 2023/04/04 13:07:43 by paula            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS_P = ft_printf.c ft_putuninbr.c  ft_uitoa.c ft_hexa.c ft_adressp.c
...
test: all
	gcc -ggdb $(FLAGS) ft_printf.c ft_putuninbr.c ft_uitoa.c ft_hexa.c ft_adressp.c $(SRCS_B) $(NAME) -lbsd -o result.out
